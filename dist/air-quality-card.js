              ...
              >
                ...
                ${e.display.icons_inline!==false?se`
                      ...
                      ${s.fan_icon?se`<span class="fan-indicator ${s.fan_state==="on"?"fan-animating":""}">
                            <ha-icon
                              icon="${s.fan_icon}"
                              style="--mdc-icon-size: 12px; color: ${s.fan_state==="on"?"var(--state-fan-active-color, var(--state-active-color))":"var(--secondary-text-color)"};"
                            ></ha-icon>
                          </span>`:""}
                    `:""}
                &nbsp;
